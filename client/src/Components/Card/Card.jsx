...
<div class="relative w-full max-w-sm bg-white  border border-gray-200 rounded-lg shadow dark:border-gray-700">
    <a href="#">
      <div class="relative p-8">
        <ButtonHeart/>
        <img class="rounded-lg  shadow-md" src="https://m.media-amazon.com/images/I/71silQR+ArL._AC_UF894,1000_QL80_.jpg" alt="product image" />
    </div>
    </a>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="text-left text-xl font-semibold tracking-tight text-gray-900 dark:text-black">Nombre: {nombre}</h5>
            <h5 class="text-left text-xl font-semibold tracking-tight text-gray-900 dark:text-black">Categoria: {categoria}</h5>
            <h5 class="text-left text-xl font-semibold tracking-tight text-gray-900 dark:text-black">Talle: {talle}</h5>
        </a>
